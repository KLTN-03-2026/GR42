              ...
              <div className="space-y-2 flex flex-col">
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`w-full bg-slate-50 border ${error && !password ? 'border-red-300' : 'border-slate-100'} rounded-[1.25rem] px-6 py-4 pr-12 focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-600 transition-all text-sm font-medium outline-none`}
                  />
                  <button 
                    type="button"
              ...
              <div className="space-y-2 flex flex-col">
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="••••••••"
                    disabled={loading || !token}
                    className={`w-full bg-slate-50 border ${error && confirmPassword !== password ? 'border-red-300' : 'border-slate-100'} rounded-[1.25rem] px-6 py-4 pr-12 focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-600 transition-all text-sm font-medium outline-none`}
                  />
                  <button 
                    type="button"
