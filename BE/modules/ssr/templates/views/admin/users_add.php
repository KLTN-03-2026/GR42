...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="?module=ssr/admin&action=users" class="btn btn-light shadow-sm rounded-pill px-4">
    ...
    <?php if(!empty($msg)): ?>
        <div class="alert alert-<?= $msgType ?> alert-dismissible fade show rounded-4" role="alert">
            ...
            <?php if($msgType == 'success'): ?>
            <a href="?module=ssr/admin&action=users" class="btn btn-sm btn-success ms-3 rounded-pill">Quay lại danh sách</a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
